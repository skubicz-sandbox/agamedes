...
class MavenExecutorToolWindow(private var project: Project) {
    ...
    private fun createWindowToolbar() {
        ...
        val actionToolbar = actionManager.createActionToolbar("EasyMavenBuilderPanel", actionManager
                .getAction("EasyMavenBuilder.ActionsToolbar") as DefaultActionGroup, true)
